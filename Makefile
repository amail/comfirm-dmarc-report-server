...
pkgdatadir = $(datadir)/comfirm-dmarc
pkgincludedir = $(includedir)/comfirm-dmarc
pkglibdir = $(libdir)/comfirm-dmarc
pkglibexecdir = $(libexecdir)/comfirm-dmarc
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
bin_PROGRAMS = comfirm_dmarc$(EXEEXT)
subdir = .
...
am_comfirm_dmarc_OBJECTS = src/master_server.$(OBJEXT) \
	src/server.$(OBJEXT) src/safe.$(OBJEXT) src/worker.$(OBJEXT) \
...
comfirm_dmarc_LINK = $(CCLD) $(AM_CFLAGS) $(CFLAGS) \
	$(comfirm_dmarc_LDFLAGS) $(LDFLAGS) -o $@
...
SOURCES = $(comfirm_dmarc_SOURCES)
DIST_SOURCES = $(comfirm_dmarc_SOURCES)
ETAGS = etags
CTAGS = ctags
...
PACKAGE_BUGREPORT = 
PACKAGE_NAME = comfirm-dmarc
PACKAGE_STRING = comfirm-dmarc 1.0
PACKAGE_TARNAME = comfirm-dmarc
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
SET_MAKE = 
...
src/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) src/$(DEPDIR)
	@: > src/$(DEPDIR)/$(am__dirstamp)
src/master_server.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/server.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/safe.$(OBJEXT): src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
src/worker.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/socket.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/cache.$(OBJEXT): src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
src/request.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/response.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/connection.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/config_file.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
...
src/lib-pq/$(am__dirstamp):
	@$(MKDIR_P) src/lib-pq
	@: > src/lib-pq/$(am__dirstamp)
src/lib-pq/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) src/lib-pq/$(DEPDIR)
	@: > src/lib-pq/$(DEPDIR)/$(am__dirstamp)
src/lib-pq/persisted_queue.$(OBJEXT): src/lib-pq/$(am__dirstamp) \
	src/lib-pq/$(DEPDIR)/$(am__dirstamp)
comfirm_dmarc$(EXEEXT): $(comfirm_dmarc_OBJECTS) $(comfirm_dmarc_DEPENDENCIES) 
	@rm -f comfirm_dmarc$(EXEEXT)
	$(comfirm_dmarc_LINK) $(comfirm_dmarc_OBJECTS) $(comfirm_dmarc_LDADD) $(LIBS)
...
mostlyclean-compile:
	...
	-rm -f src/request.$(OBJEXT)
	-rm -f src/response.$(OBJEXT)
	-rm -f src/safe.$(OBJEXT)
	-rm -f src/server.$(OBJEXT)
	-rm -f src/socket.$(OBJEXT)
	-rm -f src/worker.$(OBJEXT)

distclean-compile:
	-rm -f *.tab.c

include src/$(DEPDIR)/base64.Po
...
include src/$(DEPDIR)/request.Po
include src/$(DEPDIR)/response.Po
include src/$(DEPDIR)/safe.Po
include src/$(DEPDIR)/server.Po
include src/$(DEPDIR)/socket.Po
include src/$(DEPDIR)/worker.Po
include src/lib-pq/$(DEPDIR)/persisted_queue.Po
...
distclean-generic:
	...
	-rm -f src/lib-pq/$(DEPDIR)/$(am__dirstamp)
	-rm -f src/lib-pq/$(am__dirstamp)
...
distclean: distclean-am
	...
	-rm -rf src/$(DEPDIR) src/lib-pq/$(DEPDIR)
	-rm -f Makefile
...
install-data-local:
	...
	gcc -o dmarc-mailhandler src/lib-pq/persisted_queue.c src/mailhandler/dns.c src/mailhandler/base64.c src/mailhandler/string_buffer.c src/mailhandler/mailhandler.c -lfirm-dkim -lresolv -lcrypt -lz `xml2-config --cflags --libs`
