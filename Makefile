...
install-data-local:
	...
	gcc -o dmarc-mailhandler src/lib-pq/persisted_queue.c src/mailhandler/dns.c src/mailhandler/base64.c src/mailhandler/mailhandler.c -lfirm-dkim -lresolv -lcrypt -lz `xml2-config --cflags --libs`
